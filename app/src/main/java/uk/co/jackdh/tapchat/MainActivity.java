...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    protected DialogInterface.OnClickListener mDialogListener = new DialogInterface.OnClickListener() {
        ...
        private Uri getOutputMediaFileUri(int mediaType) {
            ...
            if (isExternalStorageAvailable()) {
                ...
                File mediaFile;
                Date now = new Date();
                String timestampe = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.ENGLISH).format(now);

                String path = mediaStorageDir.getPath() + File.separator;
                if (mediaType == MEDIA_TYPE_IMAGE) {
                    mediaFile = new File(path + "IMG" + timestampe + ".jpg");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            // This will start up the choose person to send to. The setData means the URL of the img will be sent with the intent.
